...
<div class="form-group row">
    ...
    <div class="col-md-10">
    {!! Form::text('nama', null, ['class'=>"form-cont  rol ", 'require', 'autofocus']); !!}
...
<div class="form-group row">
    ...
    <div class="col-md-10">
    {!! Form::textarea('keterangan', null, ['class'=>"form-cont  rol ", 'require', 'autofocus']); !!}
...
<div class="form-group row">
    ...
    <div class="col-md-10">
    {!! Form::text('path', null, ['class'=>"form-cont  rol ", 'require', 'autofocus']); !!}
